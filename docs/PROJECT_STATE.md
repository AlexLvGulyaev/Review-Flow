...
| 2026-09-03 | Обязательный технический долг закрыт (фиксация) | Решение владельца 03.09 (IMPLEMENTATION_PLAN AIP §3, аудит корпуса v1.22): обязательный технический долг проекта закрыт; оставшиеся пункты обязательным долгом не являются и ведутся как SHOULD/COULD-роадмап — пересъёмка галереи скриншотов (новые экраны Логи/Аудит/Обозначения + снимки до тёмной темы) — по готовности владельца |
