# 🖼️ Review Flow — каталог медиаматериалов

## 🏷️ 1. Правила нейминга
...
| `portfolio` | Витринные пары кейса (светлая/тёмная тема) | `RF_portfolio_light.png` |
| `unused` | Файлы, не используемые в текущей документации | `RF_unused_adm_operapprove.png` |

---

## 🖼️ 2. Каталог изображений
...
| IMG-044 | `RF_portfolio_light.png` | portfolio | Витрина кейса — светлая тема | README.md (hero, LIGHT), SCREENSHOTS (раздел 8) |
| IMG-045 | `RF_portfolio_dark.png` | portfolio | Витрина кейса — тёмная тема | ARCHITECTURE.md (hero, DARK), SCREENSHOTS (раздел 8) |
...
- [🖼️ `SCREENSHOTS.md`](../SCREENSHOTS.md) — галерея экранов.
- [🎬 `SYSTEM_DEMO.md`](../SYSTEM_DEMO.md) — демонстрация системы.
- [🏠 `README.md`](../../README.md) — главная страница проекта.

---

**Статус:** Актуален (скриншоты UI — в ожидании пересъёмки)
