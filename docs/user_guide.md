...
Актуальная “витринная” версия руководства находится в `docs/USER_GUIDE.md`.

Ниже сохранён исходный документ, который использовался как база и может содержать более “рабочие” заметки.
