...
- [Архитектурные и продуктовые решения (SOT)](../Архитектурные_и_продуктовые_решения_проекта_SOT_v4.md) (§3A)
- [Операционная модель Controlled Hybrid](architecture/controlled_hybrid_operational_model.md)
- [Обоснование выбора Controlled Hybrid (PDF)](architecture/controlled_hybrid_architecture_rationale.pdf)
...
Обоснование сравнений вариантов (в т.ч. по структуре затрат и рискам): [обоснование выбора Controlled Hybrid (PDF)](architecture/controlled_hybrid_architecture_rationale.pdf).
...
Confidence — это численная оценка уверенности системы в том, что выбранная типовая ситуация подходит. Она вычисляется системой на основании retrieval‑результатов и порогов (см. [операционную модель CH](architecture/controlled_hybrid_operational_model.md), раздел Confidence Workflow).
...
- [CH pipeline forensics](architecture/ch_pipeline_forensics_after_ch_integration.md)
