...
## 🕸️ 3. Почему не выбран “полный RAG” как основной контур
...
## 🗃️ 9. Как администратор расширяет базу знаний
...
Основные анти-галлюцинационные правила — п. 3–4: утверждённый текст ТС и `response_policy` — единственный источник фактов; отсутствующая деталь опускается, а не заменяется заглушкой.
...
## ✅ 12. Примечание о реализованном состоянии
...
**Статус:** Актуален — нормативный документ архитектуры CH
