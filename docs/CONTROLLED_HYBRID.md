...
- [Архитектурные и продуктовые решения (SOT)](../architecture-decisions-sot-v4.md) (§3A)
- [Операционная модель Controlled Hybrid](CONTROLLED_HYBRID.md)
...
Обоснование сравнений вариантов (в т.ч. по структуре затрат и рискам): [обоснование выбора Controlled Hybrid (PDF)](docs/controlled-hybrid-architecture-rationale.pdf).
...
Confidence — это численная оценка уверенности системы в том, что выбранная типовая ситуация подходит. Она вычисляется системой на основании retrieval‑результатов и порогов (см. [операционную модель CH](CONTROLLED_HYBRID.md), раздел Confidence Workflow).
...
- [CH pipeline forensics](docs/ch-pipeline-forensics.md)
