...
1. Оператор открывает https://review-flow.alex-n8n.site/company и входит под демо-учётной записью `operator@northline.local` / `demo`.
...
1. Администратор открывает https://review-flow-admin.alex-n8n.site и входит под `admin@northline.local` / `demo`.
