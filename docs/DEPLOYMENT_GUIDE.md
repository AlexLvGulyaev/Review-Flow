...
- Тот, кто **не будет** настраивать production-кластер — для этого в репозитории есть только локальный Compose-контур (см. §19).
...
## 🛠️ 13. Как проверить административный сценарий
...
## 🗄️ 14. Как устроены миграции и seed-данные
...
## ♻️ 15. Как сбросить демо-БД и начать заново
...
## 🚀 18. Развёртывание на VPS через центральный Traefik
...
## 🚫 19. Что не входит в локальный compose-контур
...
## ✅ 20. Чек-лист после развёртывания
