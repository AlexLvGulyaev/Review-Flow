...
-- Migrate legacy rows to review_classification
...
-- Deactivate legacy global active flags; set classification active per key
...
-- Seed review_response_generation if missing
...
-- Traceability on review_responses
