...
<img src="docs/screenshots/RF_portfolio_light.png" alt="Review Flow — витрина кейса: интерфейс системы (LIGHT)">
...
## ⚠️ 11. Ограничения демо

- **Демонстрационный MVP**: упрощённые сценарии; поддерживается `mock`-провайдер LLM (заглушка текста, не реальная LLM-адаптация) — см. [`🔌 API контракт`](docs/API_CONTRACT.md) раздел AI Provider Settings.
...
**Статус:** Портфельный актив — живое демо: клиентский портал, консоли оператора и администратора, Controlled Hybrid, отчёты
